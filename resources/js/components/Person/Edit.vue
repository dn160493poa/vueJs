<template>
    <div class="w-25" v-if="person">
        ...
        <div class="mb-3">
            <input :disabled="!isDisabled" @click.prevent="$store.dispatch('updatePerson', { 'id': person.id,
                'name': person.name, 'age': person.age, 'job': person.job})" type="submit" value="Update"
